			...
			if (cmd.equals("Ðåñåò")) {
				...
				if (a == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						JOptionPane.showMessageDialog(choozer.getParent(), ex.getMessage(), "Òû ÷¸ çà ëàë âàùå", JOptionPane.ERROR_MESSAGE);
					}
				}
